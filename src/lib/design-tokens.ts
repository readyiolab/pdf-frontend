...
export const TOOLS: ToolConfig[] = [
  {
    id: "summarize",
    name: "Summarize PDF",
    desc: "Get an instant, faithful AI summary of any PDF document.",
    icon: Sparkles,
    accent: "bg-fuchsia-50 dark:bg-fuchsia-950/30",
    accentText: "text-fuchsia-500",
    gradient: "from-fuchsia-500/10 to-fuchsia-500/5",
    // Unused — its own route does its own PDF-only validation.
    accept: ".pdf",
    multiple: false,
    categories: ["All", "PDF Intelligence"],
    route: "/ai/summarize",
    requiresAuth: true,
  },
  {
    id: "chatpdf",
    name: "Chat with PDF",
    desc: "Ask questions and get answers grounded in your document.",
    icon: MessageSquare,
  ...
  },
  {
    id: "explain",
    name: "Explain PDF",
    desc: "Turn a dense or confusing document into plain language.",
    icon: Lightbulb,
